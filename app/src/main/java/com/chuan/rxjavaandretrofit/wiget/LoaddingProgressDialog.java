...
import com.chuan.rxjavaandretrofit.utils.OptAnimationLoader;
 ...
 */
public class LoaddingProgressDialog extends Dialog{
    ...
    public LoaddingProgressDialog(Context context) {
        ...
        mModalOutAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                mDialogView.post(new Runnable() {
                    ...
                    public void run() {
                        if (mCloseFromCancel) {
                            LoaddingProgressDialog.super.cancel();
                        } else {
                            LoaddingProgressDialog.super.dismiss();
                        }
                    }
                });
            }
